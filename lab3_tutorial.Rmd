...
setwd("~/Documents/geog415/sbleakne/homework3")
...
```{r}
ggplot(data=rwi.precip.df) + geom_point(aes(x=year, y=precip))
```
...
ggplot(data=rwi.precip.df) + geom_point(aes(x=year, y=resid)) + scale_x_continuous(limits=c(1890, 2000))
